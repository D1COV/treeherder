                ...
                {this.props.test.bugs === undefined ?
                    <Icon name="spinner" spin/> : (
                        Object.keys(this.props.test.bugs).length > 0 ? Object.keys(this.props.test.bugs).length : (
                            <Badge size="sm" color='danger' style={{
                                fontWeight: 400,
                                fontSize: '.8rem',
                                margin: '0 .5rem'
                            }}>0</Badge>
    ...
    renderExpanded() {
        return (
            <div className="test-detail-list">
                <div className="bottom-separator"><strong>Test
                    Group: {this.props.test.group}</strong></div>
                ...
                <span>
                  ...
                  <div className="failure-line">
                      ...
                      {failureLine.message && failureLine.message.includes('Stack trace:') &&
                      <div>
